...
impl Config {
    ...
    pub fn get_system_plugins_path() -> PathBuf {
        ...
        let system_plugins_path = sys_config["path"]["config"]["system_plugins"].as_str().expect("Pfad zur Aufgabe nicht gefunden");
    ...
    */
    pub fn get_node_listener() -> Address {
        let listener = Address::new(&Config::get_node_host(), &Config::get_node_port());
        listener
    }
    ...
    pub fn get_node_port() -> u32 {
        ...
        let node_port = config["node_port"].as_u64().unwrap_or(50263) as u32;
        node_port
    }
    ...
    pub fn get_task_path() -> PathBuf {
        ...
        let task_relative_path = config["path"]["task"]
            .as_str()
            .expect("Pfad zur Aufgabe nicht gefunden");
    ...
    pub fn get_template_path() -> PathBuf {
        ...
        let template_relative_path = config["path"]["template"]
            .as_str()
            .expect("Pfad zur Aufgabe nicht gefunden");
    ...
    pub fn get_service_temp_path() -> PathBuf {
        ...
        let service_temp_relative_path = config["path"]["service"]["temp"]
            .as_str()
            .expect("Pfad zur Aufgabe nicht gefunden");
    ...
    pub fn get_service_static_path() -> PathBuf {
        ...
        let service_static_relative_path = config["path"]["service"]["static"]
            .as_str()
            .expect("Pfad zur Aufgabe nicht gefunden");
    ...
    pub fn get_config_links_path() -> PathBuf{
        ...
        let config_links_relative_path = sys_config["path"]["config"]["links"].as_str().expect("Pfad zur Aufgabe nicht gefunden");
    ...
    */
    pub fn get_config_default_task_path() -> PathBuf {
        ...
        let config_default_task_relative_path = config["path"]["config"]["default_task"]
            .as_str()
            .expect("Pfad zur Aufgabe nicht gefunden");
    ...
    pub fn get_software_path() -> PathBuf {
        ...
        let config_default_task_relative_path = config["path"]["config"]["software"]
            .as_str()
            .expect("Pfad zur Aufgabe nicht gefunden");
    ...
    pub fn get_software_files_path() -> PathBuf {
        ...
        let config_default_software_files_relative_path = config["path"]["config"]
            ["software_files"]
            .as_str()
